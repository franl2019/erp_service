        ...
        const sql = ` SELECT
                    ...
                    FROM (SELECT ''    AS correlationId,
                          ...
                          SELECT ''    AS correlationId,
                                 ...
                                 0     AS actuallyReceived,
                                 SUM(
                                                     0 - accounts_receivable_mx.advancesReceived + accounts_receivable_mx.receivables -
                                                     accounts_receivable_mx.actuallyReceived
                                     ) AS endingBalance,
                                 ''    AS abstract,
                                 ''    AS reMark,
                          ...
                          GROUP BY accounts_receivable.clientid ) AS accounts_receivable_mx_report
